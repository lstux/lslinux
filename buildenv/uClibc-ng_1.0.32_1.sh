...
doconf defconfig \
  ...
  set DO_C99_MATH DO_XSI_MATH FORCE_SHAREABLE_TEXT_SEGMENTS LDSO_GNU_HASH_SUPPORT \
      ...
      UCLIBC_USE_NETLINK \
  set UCLIBC_HAS_LONG_DOUBLE_MATH \
  unset PTHREADS_DEBUG_SUPPORT UCLIBC_HAS_UTMP UCLIBC_HAS_CONTEXT_FUNCS UCLIBC_SUPPORT_AI_ADDRCONFIG \
        UCLIBC_HAS_FTW SSP_QUICK_CANARY UCLIBC_BUILD_SSP
dobuild
doinstall
